...
#curl -sSL https://github.com/kishanchand11/kubernetes/raw/master/kall.sh | sudo tee kall.sh | sudo bash
#copy curl -L https://github.com/kishanchand11/kubernetes/raw/master/kall.sh | sudo tee kall.sh 
